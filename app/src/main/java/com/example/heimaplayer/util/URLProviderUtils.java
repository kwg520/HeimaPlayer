...
//                + "&size=" + size
//                + "&v=4&rn=640*540";
         String url = "http://www.yinyuetai.com/mv/get-rec?recId="+ offset+"&size="+size;
        Log.i("Main_url", url);
        return url;
    }
...
//                + "&offset=" + offset
//                + "&size=" + size;
        String url  = "http://www.yinyuetai.com/mv/get-first-video?area="+area+"&size="+size;
...
//                + "&offset=" + offset
//                + "&size=" + size;
        String url = "http://www.yinyuetai.com/mv/get-playlist?size=6";
        Log.i("YueDanUrl", url);
        return url;
    }
    ...
    public static String getVChartAreasUrl() {
        String url = "https://mapi.yinyuetai.com/vchart/get_vchart_areas.json?deviceinfo="
                + "{\"aid\":\"10201036\",\"os\":\"Android\","
                + "\"ov\":" + "\"" + getSystemVersion() + "\"" + ","
                + "\"rn\":\"480*800\","
                + "\"dn\":" + "\"" + getPhoneModel() + "\"" + ","
